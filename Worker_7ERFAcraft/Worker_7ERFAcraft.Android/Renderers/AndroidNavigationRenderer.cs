...
using System.Linq;
using System.Text;
using Worker_7ERFAcraft.Droid.CustomRenderers;
using Android.App;
...
namespace Worker_7ERFAcraft.Droid.CustomRenderers
{
    public class AndroidNavigationRenderer : NavigationPageRenderer
    {
        ...
        private void Toolbar_ChildViewAdded(object sender, ChildViewAddedEventArgs e)
        {
            ...
            if (e.Child.GetType() == typeof(Android.Support.V7.Widget.AppCompatTextView))
            {
                ...
                textView.Typeface = Typeface.CreateFromAsset(this.Context.Assets, "IBMPlexSans-SemiBold.otf");
