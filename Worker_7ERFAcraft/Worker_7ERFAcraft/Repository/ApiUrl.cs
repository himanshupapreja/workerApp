...
namespace Worker_7ERFAcraft.Repository
{
    public class ApiUrl
    {
        ...
        public const string RemoveOrderByWorker = wsBaseUrl + "order/RemoveOrderByWorker?orderId=";
        ...
        public const string SendQuoteUrl = wsBaseUrl + "Driver/SendQuote";
        public const string ApproveQuoteUrl = wsBaseUrl + "Driver/ApproveQuote";
        public const string StartEndRideUrl = wsBaseUrl + "Driver/StartEndRide";
