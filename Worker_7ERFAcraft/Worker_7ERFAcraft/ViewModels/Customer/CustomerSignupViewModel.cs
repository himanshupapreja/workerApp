...
{
    public class CustomerSignupViewModel : INotifyPropertyChanged
    {
        ...
        //public List<CountryCodeModel> lstCountriesCode
        //{
        //    get { return _lstCountriesCode; }
        //    set
        //    {
        //        _lstCountriesCode = value;
        //        PropertyChanged(this, new PropertyChangedEventArgs("lstCountriesCode"));
        //    }
        //}
        ...
        public CustomerSignupViewModel(INavigation navigation)
        {
                        ...
                        if (content != null)
                        {
                            ...
                            if (result != null)
                            {
                                if (result.status)
                                {
                                    ...
                                    {
                                        await _navigation.PushAsync(new OtpPage(result.userData.UserId.ToString())); 
                                    }
