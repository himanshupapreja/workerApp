...
namespace Worker_7ERFAcraft.Pages
{
	...
	public partial class HomeVideoPage : ContentPage
	{
		public HomeVideoPage ()
		{
			InitializeComponent ();
            NavigationPage.SetHasNavigationBar(this,false);
            image.HeightRequest = App.ScreenHeight;
            //video.HeightRequest = App.ScreenHeight;
            BindingContext = new HomeVideoViewModel(Navigation);
            LayoutClose.WidthRequest = App.ScreenWidth - (50 + 15 + 15);
