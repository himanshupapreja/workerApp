...
namespace Worker_7ERFAcraft.Pages
{
	...
	public partial class WorkerWorkDetailPage : ContentPage
	{
        public static string  latitude;
        public static string longitude;
        public static string address;

        public WorkerWorkDetailPage(string orderId)
		{
			InitializeComponent ();
            Title =Resx.AppResources.WorkDetails;// "Work Details";
            lblPhotosVideos.Text = Resx.AppResources.Photos_Videos;// "PHOTOS & VIDEOS";
            BindingContext = new WorkerWorkDetailViewModel(Navigation,orderId);
            ...
            MessagingCenter.Subscribe<WorkerWorkDetailViewModel>(this, "Hi", (sender) =>
            {
